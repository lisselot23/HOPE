// JavaScript File
console.log("pie");
var accountSid = 'AC380b10a26daa5bda893f10cde03a9dd2'; 
var authToken = 'ae1176548469361775cb469c5a911c92'; 
...
client.sendMessage({
    ...
    to: '+19148743278', // Any number Twilio can deliver to
...
client.makeCall({
    ...
    to: '+9148743278', // Any number Twilio can call
    from: '+14506667788', // A number you bought from Twilio and can use for outbound communication
